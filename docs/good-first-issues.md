...
Use these as public contributor tickets that match the current v1.0.6 product surface.
...
- **Why it matters:** v1.0.6 establishes an 80% release gate; the next useful ratchet is coverage on the lower-signal edge paths that remain
